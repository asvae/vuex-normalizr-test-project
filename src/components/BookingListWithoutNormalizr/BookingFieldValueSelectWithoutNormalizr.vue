<template>
  <v-select
    class="BookingFieldValueSelectWithoutNormalizr"
    dense
    outline
...
@Component
export default class BookingFieldValueSelectWithoutNormalizr extends Vue {
...
<style lang="scss">
.BookingFieldValueSelectWithoutNormalizr {
